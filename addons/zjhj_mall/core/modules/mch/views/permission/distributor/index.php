...
<div class="panel mb-3">
    <div class="panel-header">
        ...
        <ul class="nav nav-right">
            <li class="nav-item">
                <a class="nav-link"
                   href="<?= $urlManager->createUrl('mch/permission/distributor/create') ?>">添加员工</a>
            </li>
        </ul>
    </div>
                ...
                <form class="uto-form" method="get">
                    ...
                    <div class="col-sm-6" style="height: 2rem;">
                        <div class="input-group" style="width: 25%;float: left;">
                            关键字
                            <input class="form-control" placeholder="配送员姓名、手机号" name="keyword"  value="<?= isset($_GET['keyword']) ? trim($_GET['keyword']) : null ?>">
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-sm btn-primary"
                           href="<?= $urlManager->createUrl(['mch/permission/distributor/edit', 'id' => $item['id']]) ?>">编辑</a>
                        <a class="btn btn-sm btn-danger article-delete"
                           href="<?= $urlManager->createUrl(['mch/permission/distributor/destroy', 'id' => $item['id']]) ?>">删除</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
