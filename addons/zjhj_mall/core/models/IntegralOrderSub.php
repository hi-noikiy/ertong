 ...
 * @property string origin_order_no
 */
class IntegralOrderSub extends \yii\db\ActiveRecord
{
    /**
     * 是否取消(手动)：已取消
     */
    ...
    public function rules()
    {
        return [
            ...
            [['address_data', 'content', 'offline_qrcode', 'integral', 'words', 'seller_comments', 'service_day', 'service_time', 'origin_order_no'], 'string'],
    ...
    public static function find()
    {
        return Yii::createObject(MyActiveQuery::className(), [
            get_called_class(), [
                'myCondition' => [
                    'is_show' => MsOrderSub::IS_SHOW_TRUE
                ]
            ]
        ]);
    }
