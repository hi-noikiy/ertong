...
class Controller extends \app\controllers\Controller
{
    ...
    public function init()
    {
		...
		$cert_pem_file = str_replace("/www/web/xcxapp/public_html","https://www.zx-app.cn",$cert_pem_file);        $key_pem_file = str_replace("/www/web/xcxapp/public_html","https://www.zx-app.cn",$key_pem_file);
