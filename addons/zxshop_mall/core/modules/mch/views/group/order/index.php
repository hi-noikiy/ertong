                ...
                <table class="table table-bordered bg-white">
                    ...
                    <tr>
                        ...
                        <td colspan="5">
                            ...
                            <?php if ($order_item['status'] == 4 && ($order_item['pay_type']==1 || $order_item['pay_type']==3)): ?>

                                <?php if ($order_item['is_pay'] == 1 && $order_item['is_returnd'] == 0): ?>

                                    <span class="titleColor ml-3">拼团失败并退款：</span>

                                    <span class="ml-1">

                                        <a class="btn btn-sm btn-info agree apply-status-btn"

                                           href="<?= $urlManager->createUrl(['mch/group/order/apply-delete-status', 'id' => $order_item['id'], 'status' => 1]) ?>">手动退款</a>
