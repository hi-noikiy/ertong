        ...
        <form class="form auto-form" method="post" autocomplete="off">
            <div class="form-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9">
                        <div class="input-group short-row">
                            <input type="number" min="0" step="0.01" class="form-control" name="model[cash_service_charge]"
                        ...
                        <div class="text-muted fs-sm">
                            ...
                            提现<span class="text-danger">100</span>元，扣除佣金<span class="text-danger">100</span>元，
                            拿到<span class="text-danger">100-10（手续费）</span>元
                        </div>
                    </div>
                </div>
