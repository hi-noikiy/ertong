...
Page({
    ...
    onLoad: function(e) {
        ...
        app.pageOnLoad(t, e), t.setData({
            ...
            method: "POST",
            success: function(e) {
                swan.hideLoading(), 0 == e.code && (t.setData(e.data), t.setData({
                    current_key: 0
            ...
            success: function(e) {
                if (0 == e.code) {
                    if (setTimeout(function() {
                        swan.hideLoading();
                    }, 1e3), "WECHAT_PAY" == n) return setOnShowScene("pay"), void swan.requestPayment({
                        _res: e,
                        ...
                        complete: function(e) {
                            "requestPayment:fail" != e.errMsg && "requestPayment:fail cancel" != e.errMsg ? "requestPayment:ok" == e.errMsg && swan.showModal({
                                title: "提示",
                                content: "充值成功",
                                showCancel: !1,
                                confirmText: "确认",
