...
Page({
    data: {
        x: swan.getSystemInfoSync().windowWidth,
        y: swan.getSystemInfoSync().windowHeight,
        left: 0,
        show_notice: !1,
        animationData: {},
        play: -1,
    ...
    Edition: function () {
        var that = this;
        console.log(swan.getSystemInfoSync().version)

        compareVersion('10.10.0', swan.getSystemInfoSync().version)
    ...
    loadData: function (t) {
        var o = this,
            a = swan.getStorageSync("pages_index_index");
        ...
        app.request({
            ...
            success: function (t) {
                ...
                if (0 == t.code) {
                    ...
                    swan.setStorageSync("store", t.data.store),

                     swan.setStorageSync("pages_index_index", t.data);

                    var s = swan.getStorageSync("user_info");
    ...
    onShow: function () {
        ...
        var t = swan.getStorageSync("store");
        t && t.name && swan.setNavigationBarTitle({
            title: t.name
    ...
    onShareAppMessage: function (t) {
        var a = this;
        return {
            path: "/pages/index/index?user_id=" + swan.getStorageSync("user_info").id,
            success: function (t) {
    ...
    onConfirm: function (t) {
        ...
        var u = swan.getStorageSync("item").quick_list, _ = a.data.goods, p = u.length, h = [];
    ...
    receive: function (t) {
        ...
        swan.showLoading({
            ...
            success: function (t) {
                swan.hideLoading(), 0 == t.code ? e.setData({
    ...
    onPageScroll: function (t) {
        ...
        if (!fullScreen && -1 != a.data.play) {
            var e = swan.getSystemInfoSync().windowHeight;
            "undefined" == typeof my ? swan.createSelectorQuery().select(".video").fields({
                rect: !0
            }, function (t) {
                (t.top <= -200 || t.top >= e - 57) && a.setData({
                    play: -1
                });
            }).exec() : swan.createSelectorQuery().select(".video").boundingClientRect().scrollOffset().exec(function (t) {
