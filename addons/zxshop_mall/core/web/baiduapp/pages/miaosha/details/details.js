...
Page({
    ...
    numberAdd: function() {
        ...
        if (++a > t.data.goods.miaosha.buy_max && 0 != t.data.goods.miaosha.buy_max) return swan.showToast({
    ...
    numberBlur: function(t) {
        ...
        o = parseInt(o), isNaN(o) && (o = 1), o <= 0 && (o = 1), o > a.data.goods.miaosha.buy_max && 0 != a.data.goods.miaosha.buy_max && (swan.showToast({
    ...
    buyNow: function() {
        this.data.goods.miaosha ? this.submit("BUY_NOW") : swan.showModal({
            title: "提示",
