...
Page({
    ...
    onLoad: function(t) {
        ...
        swan.removeStorageSync("input_data"), this.setData({
            options: t,
    ...
    onShow: function() {
        app.pageOnShow(this);
        var t = this, a = swan.getStorageSync("picker_address");
        a && (t.setData({
            address: a,
            name: a.name,
            mobile: a.mobile
        }), swan.removeStorageSync("picker_address"), t.getInputData()), t.getOrderData(t.data.options);
    },
    getOrderData: function(t) {
        var s = this, a = "";
        s.data.address && s.data.address.id && (a = s.data.address.id), t.goods_info && (swan.showLoading({
            title: "正在加载",
            mask: !0
        }), app.request({
            ...
            success: function(t) {
                ...
                1 == t.code && swan.showModal({
                    ...
                    confirmText: "返回",
                    success: function(t) {
                        t.confirm && (1 == getCurrentPages().length ? swan.redirectTo({
    ...
    pickShop: function(t) {
        ...
        swan.removeStorageSync("input_data"), e.show_shop = !1, e.shop = "-1" != a && -1 != a && this.data.shop_list[a], 
