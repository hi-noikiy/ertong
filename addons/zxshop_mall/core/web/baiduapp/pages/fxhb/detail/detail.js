...
Page({
    ...
    onLoad: function(t) {
        ...
        swan.showLoading({
            ...
            success: function(a) {
                swan.hideLoading(), 1 != a.code ? (0 == a.code && (e.setData({
                    rule: a.data.rule,
                ...
                }), e.setRestTimeStr()), e.showShareModal()) : swan.showModal({
                    title: "提示",
                    content: a.msg,
                    showCancel: !1,
                    success: function(t) {
                        t.confirm && (1 == a.game_open ? swan.redirectTo({
    ...
    detailSubmit: function(t) {
        ...
        swan.showLoading({
            ...
            success: function(t) {
                if (1 == t.code) return swan.hideLoading(), void a.showToast({
                    title: t.msg,
                    complete: function() {
                        0 == t.game_open && swan.redirectTo({
                            url: "/pages/index/index"
                        });
                    }
                });
                0 == t.code && (swan.hideLoading(), a.showToast({
                    title: t.msg,
                    complete: function() {
                        1 == t.reload && swan.redirectTo({
