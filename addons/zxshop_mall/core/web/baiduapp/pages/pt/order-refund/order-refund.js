    ...
    refundSubmit: function(t) {
        ...
        if (1 == a) {
            var e = function() {
                ...
                if (0 == (d = i.data.refund_data_1.desc || "").length) return swan.showToast({
                    title: "请填写退款原因",
                    image: "/images/icon-warning.png"
                }), {
                    v: void 0
                };
                if (n = [], s = 0, i.data.refund_data_1.pic_list && 0 < i.data.refund_data_1.pic_list.length) for (o in swan.showLoading({
                    title: "正在上传图片",
                    mask: !0
                    ...
                    swan.uploadFile({
                        ...
                        complete: function(t) {
                            ...
                            s == i.data.refund_data_1.pic_list.length && (swan.hideLoading(), e());
                        }
                    });
                }(o); else e();
            }();
        ...
        if (2 == a) {
            var d, n, s, o, c = function() {
                ...
                if (0 == (d = i.data.refund_data_2.desc || "").length) return swan.showToast({
                    title: "请填写换货说明",
                    image: "/images/icon-warning.png"
                }), {
                    v: void 0
                };
                if (n = [], s = 0, i.data.refund_data_2.pic_list && 0 < i.data.refund_data_2.pic_list.length) for (o in swan.showLoading({
                    title: "正在上传图片",
                    mask: !0
                    ...
                    swan.uploadFile({
                        ...
                        complete: function(t) {
                            s++, 200 == t.statusCode && 0 == (t = JSON.parse(t.data)).code && (n[a] = t.data.url), 
                            s == i.data.refund_data_2.pic_list.length && (swan.hideLoading(), e());
                        }
                    });
                }(o); else e();
            }();
