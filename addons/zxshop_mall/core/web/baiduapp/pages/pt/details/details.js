...
Page((_defineProperty(_Page = {
    ...
    onLoad: function(t) {
        ...
        var s = swan.getStorageSync("store");
        this.setData({
            store: s
        });
    },
    ...
    onHide: function() {},
    onUnload: function() {
        swan.removeStorageSync("pt_group_detail");
    },
    onPullDownRefresh: function() {},
    onReachBottom: function() {},
    onShareAppMessage: function() {
        var t = this, a = swan.getStorageSync("user_info"), e = "/pages/pt/details/details?gid=" + t.data.goods.id + "&user_id=" + a.id;
        return {
    ...
    goArticle: function(t) {
        this.data.group_rule_id && swan.navigateTo({
    ...
    submit: function(t, a) {
        ...
        if (e.data.form.number > e.data.goods.num) return swan.showToast({
        ...
        var c = 0;
        e.data.oid && (t = "GROUP_BUY_C", c = e.data.oid), swan.redirectTo({
    ...
    numberAdd: function() {
        var t = this.data.form.number;
        ++t > this.data.goods.one_buy_limit && 0 != this.data.goods.one_buy_limit ? swan.showModal({
            title: "提示",
            content: "数量超过最大限购数",
            showCancel: !1,
            success: function(t) {}
    ...
    numberBlur: function(t) {
        ...
        a = parseInt(a), isNaN(a) && (a = 1), a <= 0 && (a = 1), a > this.data.goods.one_buy_limit && 0 != this.data.goods.one_buy_limit && (swan.showModal({
            title: "提示",
            content: "数量超过最大限购数",
            showCancel: !1,
            success: function(t) {}
