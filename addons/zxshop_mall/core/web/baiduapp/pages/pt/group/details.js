...
Page((_defineProperty(_Page = {
    ...
    onShareAppMessage: function(t) {
        var a = this, o = swan.getStorageSync("user_info"), e = "/pages/pt/group/details?oid=" + a.data.oid + "&user_id=" + o.id;
        return {
    ...
    numberAdd: function() {
        ...
        ++a > t.data.goods.one_buy_limit && 0 != t.data.goods.one_buy_limit ? swan.showModal({
            title: "提示",
    ...
    numberBlur: function(t) {
        ...
        if (o = parseInt(o), isNaN(o) && (o = 1), o <= 0 && (o = 1), o > a.data.goods.one_buy_limit && 0 != a.data.goods.one_buy_limit) return swan.showModal({
            title: "提示",
