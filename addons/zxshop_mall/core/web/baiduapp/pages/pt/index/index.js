...
Page({
    ...
    onLoad: function(t) {
        this.systemInfo = swan.getSystemInfoSync(), app.pageOnLoad(this, t);
    ...
    quickNavigation: function() {
        ...
        var a = this.data.store, t = swan.createAnimation({
            duration: 300,
            timingFunction: "ease-out"
        }), o = swan.createAnimation({
            duration: 300,
            timingFunction: "ease-out"
        }), e = swan.createAnimation({
            duration: 300,
            timingFunction: "ease-out"
        }), i = swan.createAnimation({
            duration: 300,
            timingFunction: "ease-out"
        }), n = swan.createAnimation({
            duration: 300,
            timingFunction: "ease-out"
        }), s = -55;
    ...
    loadIndexInfo: function(a) {
        ...
        swan.showLoading({
            ...
            success: function(a) {
                0 == a.code && (swan.hideLoading(), t.setData({
                    cat: a.data.cat,
                    banner: a.data.banner,
                    ad: a.data.ad,
    ...
    getGoods: function(a) {
        ...
        swan.showLoading({
            ...
            success: function(a) {
                0 == a.code && (swan.hideLoading(), t.data.goods = t.data.goods.concat(a.data.list), 
                t.setData({
                    goods: t.data.goods,
                    page: a.data.page,
    ...
    navigatorClick: function(a) {
        ...
        return "wxapp" != t || ((o = function(a) {
            ...
            return e;
        }(o)).path = o.path ? decodeURIComponent(o.path) : "", swan.navigateToMiniProgram({
            appId: o.appId,
            path: o.path,
            complete: function(a) {}
        }), !1);
