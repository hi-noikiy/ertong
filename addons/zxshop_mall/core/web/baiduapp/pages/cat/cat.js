...
Page({
    ...
    onLoad: function (t) {
        ...
        var a = swan.getStorageSync("store"),

            e = t.cat_id;

        console.log(a)

        void 0 !== e && e && (this.data.cat_style = a.cat_style = -1,
            swan.showLoading({
                title: "正在加载",
                mask: !0
            }),
    ...
    onShow: function () {
        swan.hideLoading(),
            app.pageOnShow(this),
            -1 !== this.data.cat_style && this.loadData();
    },

    loadData: function (t) {
        var a = this;
        if ("" == a.data.cat_list || 5 != swan.getStorageSync("store").cat_style && 4 != swan.getStorageSync("store").cat_style && 2 != swan.getStorageSync("store").cat_style) {
            var e = swan.getStorageSync("cat_list");
            e && a.setData({
                cat_list: e,
                current_cat: null
            }), app.request({
                ...
                success: function (t) {
                    0 == t.code && (a.data.cat_list = t.data.list, 5 === swan.getStorageSync("store").cat_style && a.goodsAll({
                        currentTarget: {
                            dataset: {
                                index: 0
                            }
                        }
                    }), 4 !== swan.getStorageSync("store").cat_style && 2 !== swan.getStorageSync("store").cat_style || a.catItemClick({
                        currentTarget: {
                            dataset: {
                                index: 0
                            }
                        }
                    }), 1 !== swan.getStorageSync("store").cat_style && 3 !== swan.getStorageSync("store").cat_style || (a.setData({
                        cat_list: t.data.list,
                        current_cat: null
                    }), swan.setStorageSync("cat_list", t.data.list)));
                },
                complete: function () {
    ...
    childrenCat: function (i) {
        ...
        app.request({
            ...
            success: function (t) {
                if (0 == t.code) {
                    ...
                    for (var e in t.data.list) for (var s in t.data.list[e].id == i && (a = !1, o.data.current_cat = t.data.list[e],
                        ...
                        t.data.list[e].list) t.data.list[e].list[s].id == i && (a = !1, o.data.current_cat = t.data.list[e],
                            o.goodsItem({
                                currentTarget: {
                                    dataset: {
                                        index: s
            ...
            complete: function () {
                swan.stopPullDownRefresh(), swan.createSelectorQuery().select("#cat").boundingClientRect().exec(function (t) {
                    o.setData({
                        height: t[0].height
                    });
                });
    ...
    goodsAll: function (s) {
        var i = this,
            t = s.currentTarget.dataset.index,
            o = i.data.cat_list,
            a = null;
        ...
        // ) {
        //     var c = s.currentTarget.offsetLeft,
        //         r = i.data.scrollLeft;
        //            r = c - 80,
        //         i.setData({
        //             scrollLeft: r
        ...
        swan.createSelectorQuery().select("#catall").boundingClientRect().exec(function (t) {
            i.setData({
                height: t[0].height
            });
        });
    ...
    list: function (a, t) {
        ...
        app.request({
            ...
            success: function (t) {
                console.log(t)
                0 == t.code && (swan.hideLoading(), 0 == t.data.list.length && (is_no_more = !0),
                    e.setData({
                        page: s + 1
                    }), e.setData({
            ...
            complete: function () {
                1 == t && swan.createSelectorQuery().select("#catall").boundingClientRect().exec(function (t) {
                    e.setData({
                        height: t[0].height
                    });
                });
    ...
    onReachBottom: function () {
        is_no_more || 5 != swan.getStorageSync("store").cat_style && -1 != this.data.cat_style || this.loadMoreGoodsList();
    },
