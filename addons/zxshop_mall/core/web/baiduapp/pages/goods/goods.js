...
Page({
    data: {
        ...
        y: swan.getSystemInfoSync().windowHeight - 20,
    ...
    onLoad: function (t) {
        ...
        var o = t.quick;
        if (o) {
            var i = swan.getStorageSync("item");
    ...
    getCacheData: function () {
        var t = swan.getStorageSync("item");
        page.setData({
        ...
        app.request({
            ...
            success: function (t) {
                if (0 == t.code) {
                    ...
                    var a = t.data.detail;
                    //   WxParse.wxParse("detail", "html", a, o),
                    var myrich = a;
    ...
    jia: function (t) {
        ...
        for (var s in i) for (var e in i[s].goods) if (parseInt(i[s].goods[e].id) === parseInt(o.id)) {
            ...
            if (r > JSON.parse(i[s].goods[e].attr)[0].num) return swan.showToast({
                title: "商品库存不足",
    ...
    attrClick: function (t) {
        ...
        for (var _ in c) {
            ...
            if (g.sort().join() === n.sort().join()) {
                if (0 === parseInt(c[_].num)) return void swan.showToast({
        ...
        if (i.length === o.length) {
            ...
            for (var d in r) {
                ...
                for (var c in r[d].attr_list) if (n.push([r[d].attr_list[c].attr_id, s.id]), n.sort().join() === i.sort().join()) {
                    ...
                    if (e > r[d].num) return void swan.showToast({
                        title: "商品库存不足",
                        image: "/images/icon-warning.png"
                    });
                }
    ...
    submit: function (t) {
        ...
        if (a.data.miaosha_data && 0 < a.data.miaosha_data.rest_num && a.data.form.number > a.data.miaosha_data.rest_num) return swan.showToast({
            title: "商品库存不足，请选择其它规格或数量",
            image: "/images/icon-warning.png"
        }), !0;
        if (a.data.form.number > a.data.goods.num) return swan.showToast({
            title: "商品库存不足，请选择其它规格或数量",
            image: "/images/icon-warning.png"
        }), !0;
        ...
        if ("ADD_CART" == t && (swan.showLoading({
            title: "正在提交",
            mask: !0
        }), app.request({
    ...
    play: function (t) {
        ...
        this.setData({
            ...
            hide: "",
            show: !0
        }), swan.createVideoContext("video").play();
    },
    close: function (t) {
        ...
        this.setData({
            hide: "hide",
            show: !1
        }), swan.createVideoContext("video").pause();
    },
    hide: function (t) {
    ...
    getGoodsQrcode: function () {
        ...
        app.request({
            ...
            success: function (t) {
                ...
                }), 1 == t.code && (a.goodsQrcodeClose(), swan.showModal({
                    title: "提示",
                    content: t.msg,
                    showCancel: !1,
                    success: function (t) {
