...
Page({
    ...
    getOffline: function (t) {
        var e = this, a = t.currentTarget.dataset.offline,
        ...
        swan.chooseLocation({
            ...
            fail: function (t) {
                app.getauth({
                    ...
                    success: function (t) {
                        t && (t.authSetting["scope.userLocation"] ? e.dingwei() : swan.showToast({
                            title: "您取消了授权",
        ...
        for (var s in i) {
            ...
            if (n && 1 == n.is_form && 0 == i[s].mch_id) {
                ...
                for (var r in o) if (1 == o[r].required) if ("radio" == o[r].type || "checkbox" == o[r].type) {
                    ...
                    if (!d) return swan.showModal({
                        title: "提示",
                        content: "请填写" + n.name + "，加‘*’为必填项",
                        showCancel: !1
                    }), !1;
                } else if (!o[r].default || null == o[r].default) return swan.showModal({
                    title: "提示",
                    content: "请填写" + n.name + "，加‘*’为必填项",
                    showCancel: !1
                }), !1;
            ...
            if (1 == i.length && 0 == i[s].mch_id && 1 == i[s].offline); else {
                if (!e.data.address) return swan.showModal({
                    title: "提示",
                    content: "请选择收货地址",
                    showCancel: !1
                }), !1;
    ...
    onShow: function (t) {
        if (!is_loading_show) {
            ...
            var e = this,
                a = swan.getStorageSync("picker_address");
            a && e.setData({
                address: a
            })
            e.getOrderData(e.data.options);
    ...
    getOrderData: function (t) {
        ...
        _.data.address && _.data.address.id && (a = _.data.address.id),
            ...
            swan.showLoading({
                title: "正在加载",
                mask: !0
            }),e.mch_list = t.mch_list,console.log(e.mch_list);
        ...
        app.request({
            ...
            success: function (t) {
                ...
                if (swan.hideLoading(), 0 == t.code) {
                    ...
                    var e = swan.getStorageSync("input_data"),
                    ...
                    for (var r in e && (o = e.mch_list, i = e.payment, s = e.integral_radio),
                    ...
                    for (var r in n) {
                        ...
                        if (n[r].show = !1, n[r].show_length = n[r].goods_list.length - 1)

                            console.log("1222222")

                        for (var c in o) n[r].mch_id == o[c].mch_id && (n[r].content = o[c].content,
                        ...
                        if (l)
                            for (var c in n[r].coupon_list)
                                if (l.id == n[r].coupon_list[c].id) {
                                    n[r].picker_coupon = l;
                                    break;
                                }
                   ...
                   console.log(a) 
                    ...
                    var h = _.data.index;
                    -1 != h && n[h].shop_list && 0 < n[h].shop_list.length &&
                        _.setData({
                            show_shop: !0,
    ...
    showCouponPicker: function (t) {
        ...
        this.getInputData(),
            ...
            a[e].coupon_list && 0 < a[e].coupon_list.length && this.setData({
    ...
    pickShop: function (t) {
        var e = t.currentTarget.dataset.index, a = this.data.index, i = swan.getStorageSync("input_data"), s = i.mch_list;
    ...
    getInputData: function () {
        ...
        console.log(t)
        swan.setStorageSync("input_data", e);
    },
    ...
    goToAddress: function () {
        is_loading_show = !1, swan.navigateTo({
