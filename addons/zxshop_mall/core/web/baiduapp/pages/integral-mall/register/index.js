...
Page({
    ...
    doDay: function(t) {
        ...
        this.setSchedule(a);
        var u = swan.getStorageSync("currentDayList");
        for (var g in u) ;
    ...
    setSchedule: function(t) {
        ...
        swan.setStorageSync("currentDayList", o);
    },
        ...
        app.request({
            ...
            success: function(t) {
                if (0 == t.code) {
                    ...
                    var a = swan.getStorageSync("currentDayList"), r = [];
    ...
    calendarSign: function() {
        ...
        if (e && parseInt(t) != parseInt(e)) swan.showToast({
            title: "日期不对哦",
