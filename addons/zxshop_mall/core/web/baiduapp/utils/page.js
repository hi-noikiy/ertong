module.exports = {
    ...
    onLoad: function (t, e) {
        ...
        t.setData({
            ...
            __is_comment: a.is_comment
        }), "undefined" != typeof my && "pages/login/login" != t.route && e && (t.options || (t.options = e),
            swan.setStorageSync("last_page_options", e)), this.currentPage = t;
        var i = this;
        if (t.options) {
            var n = 0;
            ...
            n && swan.setStorageSync("parent_id", n);
        }
        ...
        this.setPageNavbar(t), t.naveClick = function (e) {
            ...
            this.setPageClasses(),
            this.setUserInfo(),
            void 0 === t.showLoadling && (t.showLoading = function (e) {
                i.showLoading(e);
    ...
    setPageNavbar: function (n) {
        var t = this, e = swan.getStorageSync("_navbar");
        e && o(e);
        var a = !1;
        ...
        a && getApp().request({
            ...
            success: function (e) {
                0 == e.code && (o(e.data), swan.setStorageSync("_navbar", e.data), t.setPageClasses());
            }
        });
    },
    ...
    setUserInfo: function () {
        var e = this.currentPage, t = swan.getStorageSync("user_info");
        t && e.setData({
            __user_info: t
        });
    },
    ...
    setWxappImg: function (e) {
        var t = this.currentPage,
            a = swan.getStorageSync("wxapp_img");
            console.log(a)
        a && t.setData({
            __wxapp_img: a
        });
    ...
    setBarTitle: function (e) {
        var t = this.currentPage.route, a = swan.getStorageSync("wx_bar_title");
        for (var i in a) a[i].url === t && swan.setNavigationBarTitle({
            title: a[i].title
        });
    },
    setAlipayMpConfig: function () {
        var t = this.currentPage, a = swan.getStorageSync("alipay_mp_config");
        a ? t.setData({
            __alipay_mp_config: a
        }) : getApp().request({
            url: getApp().api.default.store,
            success: function (e) {
                0 == e.code && (a = e.data.alipay_mp_config, swan.setStorageSync("alipay_mp_config", a),
                    t.setData({
                        __alipay_mp_config: a
                    }));
            }
    ...
    openWxapp: function (e) {
        if (console.log("openWxapp---\x3e", e.currentTarget.dataset), e.currentTarget.dataset.url) {
            ...
            (t = function (e) {
                ...
                return i;
            }(t)).path = t.path ? decodeURIComponent(t.path) : "", swan.navigateToMiniProgram({
                appId: t.appId,
                path: t.path,
                complete: function (e) { }
            });
