var p_animation, bout, animation, api = require("../../api.js"),
    app = getApp();
Page({
    data: {
        circleList: [],
    ...
    onShow: function() {
        ...
        swan.showLoading({
            ...
            success: function(t) {
                ...
                for (var a = 18, e = 18, n = 0; n < 8; n++) 0 == n ? e = a = 18 : n < 3 ? (a = a, e = e + 196 + 8) : n < 5 ? (e = e, a = a + 158 + 8) : n < 7 ? (e = e - 196 - 8, a = a) : n < 8 && (e = e, a = a - 158 - 8), i[n].topAward = a, i[n].leftAward = e;
                o.setData({
                    awardList: i
                })
            },
            complete: function(t) {
                ...
                for (var a = 4, e = 4, i = [], n = 0; n < 24; n++) {
                    if (0 == n) a = e = 8;
                    else if (n < 6) e = 4, a += 110;
                    else if (6 == n) e = 8, a = 660;
                    else if (n < 12) e += 92, a = 663;
                    else if (12 == n) e = 545, a = 660;
                    else if (n < 18) e = 550, a -= 110;
                    else if (18 == n) e = 545, a = 10;
                    else {
                        if (!(n < 24)) return;
                        e -= 92, a = 5
                    }
    ...
    startGame: function() {
        ...
        if (!o.data.isRunning) if (0 != o.data.oppty) if (o.data.integral) if (o.data.time) {
            ...
            var a = o.data.indexSelect,
                ...
                r = setInterval(function() {
                    if (a++, a %= 8, e += 30, o.setData({
                        ...
                        if (clearInterval(r), o.pond_animation(), 5 == s[a].type) var t = 1;
                        else t = 2;
                        o.setData({
                            isRunning: !1,
                            name: s[a].name,
            ...
            app.request({
                ...
                success: function(i) {
                    if (1 == i.code) return clearInterval(r), swan.showModal({
                        title: "很抱歉",
    ...
    pond_animation: function() {
        ...
        p_animation = setInterval(function() {
            a ? (animation.translate(0, 0).step(), a = !1) : (animation.translate(0, -3).step(), a = !0), t.setData({
                animationData: animation.export()
            })
        }, 900)
    },
    ...
    onShareAppMessage: function() {
        return {
            path: "/pond/pond/pond?user_id=" + swan.getStorageSync("user_info").id,
