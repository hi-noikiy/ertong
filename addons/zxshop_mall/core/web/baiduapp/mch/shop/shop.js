...
Page({
    ...
    onScroll: function(t) {
        var o = this;
        swan.createSelectorQuery().selectViewport(".after-navber").scrollOffset(function(t) {
    ...
    getShopData: function() {
        var a = this,
            ...
            t = swan.getStorageSync(s);
        t && a.setData({
            shop: t.shop
        }), swan.showNavigationBarLoading(), a.setData({
            loading: !0
        }), app.request({
            url: api.mch.shop,
            data: {
            ...
            success: function(t) {
                ...
                }), swan.setStorageSync(s, t.data)) : swan.showModal({
                    title: "提示",
                    content: t.msg,
                    showCancel: !1,
                    success: function(t) {
            ...
            complete: function() {
                swan.hideNavigationBarLoading(), a.setData({
                    loading: !1
                })
            }
        })
