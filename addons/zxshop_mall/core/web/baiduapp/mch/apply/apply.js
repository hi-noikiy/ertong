...
Page({
    ...
    onLoad: function(a) {
        ...
        t.getDistrictData(function(a) {
            ...
            url: api.mch.apply,
            success: function(a) {
                swan.hideLoading(), 0 == a.code && (a.data.apply && (a.data.show_result = !0), t.setData(a.data), a.data.apply || t.setData({
                    is_form_show: !0
                }))
            }
        })
    ...
    getDistrictData: function(t) {
        var e = swan.getStorageSync("district");
        if (!e) return swan.showLoading({
            title: "正在加载",
            mask: !0
        }), void app.request({
            url: api.
            default.district,
            success: function(a) {
                swan.hideLoading(), 0 == a.code && (e = a.data, swan.setStorageSync("district", e), t(e))
            }
        });
        t(e)
    },
    ...
    applySubmit: function(a) {
        var t = this;
        !t.data.entry_rules || t.data.agree_entry_rules ? (swan.showLoading({
            title: "正在提交",
            mask: !0
        }), app.request({
