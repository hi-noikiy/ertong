...
//            leader_id:团长id
    public function getCarts(){
        ...
        $list = Cart::where('t1.user_id',$user_id)
            ...
            ->field('t1.*,t3.name,coalesce(t2.price,t3.price) as price,case when t2.pic then t2.pic else t3.pic end pic,t3.pics,t3.use_attr,t3.delivery_fee,t3.mandatory,t1.goods_id')
            ->select();
