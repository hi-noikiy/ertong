...
//        订单保存验证
        ...
        $wxinfo=$wx->pay($user['openid'],$order_model->pay_amount + (isset($order_model->delivery_fee)?$order_model->delivery_fee:0),$order_model->id,'Order','商城订单'.$order_model->order_no);
