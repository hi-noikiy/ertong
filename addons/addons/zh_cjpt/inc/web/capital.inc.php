...
$rst=pdo_fetch($sql2);
$sql3=" select count(id) as count from ".tablename('cjpt_dispatch')." where qs_id={$value['qs_id']} and FROM_UNIXTIME(jd_time,'%Y-%m-%d') like'%{$value['days']}%' and state=5 and item=1";
$rst2=pdo_fetch($sql3);
