...
{	
	...
	static function ihttp_email($to, $subject, $body, $global = false) {
		...
		if (empty($mailer)) {
			...
			$set = pdo_get('zxbddiy_sitetemp_smtp');
...
//		var_dump($codedata);
		$url = "https://openapi.baidu.com/rest/2.0/smartapp/app/qrcode?access_token=" . $access_token;
//		var_dump($url);
		$datares = str_replace("\\/", "/",  json_encode( $codedata ));
...
//../addons/zxbddiy_countprice/admin/public/ueditor.all.js
