...
<div class='container' style='padding: 0 5px 10px; margin: 0; width: 100%'>
    ...
    <div class="row-fluid">
        <div class="span8 control-group">
            <a onclick="return confirm('清除当前推广图片缓存，确认吗？'); return false;" href="<?php  echo $this->createWebUrl('cards', array('op' => 'clearall'))?>" title="删除"
               class="btn btn-danger"><i class="fa fa-times">清除当前推广图片缓存</i></a>
        </div>
    </div>

    <script type="text/javascript" src="<?php echo RES;?>admin/js/jquery.gcjs.js"></script>
    <script type="text/javascript" src="<?php echo RES;?>admin/js/jquery.form.js"></script>
    <script type="text/javascript" src="<?php echo RES;?>admin/js/tooltipbox.js"></script>
    <script language='javascript' src="<?php echo RES;?>admin/js/designer.js"></script>
    <script language='javascript' src="<?php echo RES;?>admin/js/jquery.contextMenu.js"></script>
    <link href="<?php echo RES;?>admin/js/jquery.contextMenu.css" rel="stylesheet">
    <style type='text/css'>
        #poster {
    ...
    <form class="form-horizontal form"  action="" method="post"  id="theform" enctype="multipart/form-data">
        <input type='hidden' name='posterid' value="<?php  echo $poster['id'];?>"/>
                            ...
                            <tr>
                                <td style='width:300px;padding:10px;' valign='top'>
                                    <div id='poster'>
                                        ...
                                        <div class="drag" type="<?php  echo $d['type'];?>" index="<?php  echo $key+1?>" style="zindex:<?php  echo $key+1?>;left:<?php  echo $d['left'];?>;top:<?php  echo $d['top'];?>; width:<?php  echo $d['width'];?>;height:<?php  echo $d['height'];?>" src="<?php  echo $d['src'];?>" size="<?php  echo $d['size'];?>" color="<?php  echo $d['color'];?>" >
                                            <?php  if($d['type']=='qr') { ?>
                                            ...
                                            <div class="rLeftUp"> </div><div class="rRight"> </div>
                                            <div class="rLeft"> </div><div class="rUp"> </div>
                                            <div class="rDown"></div>
                                        </div>
                                        <?php  } } ?>
                                        <?php  } ?>
