...
<div class="header">
    <div class="wheaderbox">
        <img class="header_logo" src="<?php  if($res['link_logo']) { ?><?php  echo tomedia($res['link_logo'])?><?php  } else { ?>../addons/zh_tcwq/template/images/htlogo.png<?php  } ?>" alt=""/>
		...
		<div class="row">
			...
			<div class="row yg_top">
				...
				<div class="big-menu">
					...
					<?php  if($cur_store) { ?>
					<div class="yg_login">
						<img src="<?php  echo tomedia($cur_store['logo'])?>">
						<div><?php  echo $cur_store['store_name'];?></div>
					</div>
