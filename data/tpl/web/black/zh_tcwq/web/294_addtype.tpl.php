        ...
        <div class="panel panel-default ygdefault">
            ...
            <div class="panel-body">
               ...
               <!--  <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">本地发帖金额</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">全国版发帖金额</label>
                    <div class="col-sm-9">
                        <input type="text" name="money2" onkeyup="value=value.replace(/[^\d.]/g,'')" class="form-control" value="<?php  echo $info['money2'];?>" />
                        <span class="help-block">*当前所属分类发帖一条所需要支付的费用</span>
                    </div>
                </div>
                <div class="form-group">
...
<!--                   <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">查看电话金额</label>
                    <div class="col-sm-9">
                        <input type="text" name="tel_money" onkeyup="value=value.replace(/[^\d.]/g,'')" class="form-control" value="<?php  echo $info['tel_money'];?>" />
                        <span class="help-block">*当前所属分类刷新一条帖子所需要支付的费用</span>
                    </div>
                </div> -->
                <div class="form-group">
