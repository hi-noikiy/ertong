    ...
    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data">
        ...
        <div class="panel panel-default ygdefault">
            ...
            <div class="panel-body">
                ...
                <span class="help-block">*跳转活动单页请按以下格式填写(../hdzx/hdzx?name=自定义活动中心标题)</span>
                <span class="help-block">*跳转限时抢购单页请按以下格式填写(../xsqg/xsqg)</span>
                <span class="help-block">*跳转拼团单页请按以下格式填写(../collage/index)</span>
                <span class="help-block">*跳转活动分类请按以下格式填写(../hdzx/hdzxtype?id=活动分类的id&name=分类名称)</span>
                <span class="help-block">*跳转优惠券分类请按以下格式填写(../wdq/yhqtype?id=优惠券分类的id&name=分类名称)</span>
                <span class="help-block">*跳转优惠券单页请按以下格式填写(../wdq/yhqzx?name=自定义优惠券中心标题)</span>
