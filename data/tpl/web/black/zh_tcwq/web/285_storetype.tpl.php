                ...
                <div class="row">
                    <table class="yg5_tabel col-md-12">
                        ...
                        <tr class="yg5_tr2">
                            ...
                            <td>
                                <a href="<?php  echo $this->createWebUrl('addstoretypead', array('type_id' => $row['id'],'type'=>1))?>" class="storespan btn btn-xs">
                                        <span class="fa fa-file-image-o"></span>
                                        <span class="bianji" style="left: -30px;">添加轮播图
                        ...
                        <?php  if(empty($row['ej'])) { ?>
                          ...
                          <?php  if(is_array($row['ej'])) { foreach($row['ej'] as $son) { ?>
                            <tr class="yg5_tr3">
                                ...
                                <td>
                                 <a href="<?php  echo $this->createWebUrl('addstoretypead', array('type_id' => $son['id'],'type'=>2))?>" class="storespan btn btn-xs">
                                        <span class="fa fa-file-image-o"></span>
                                        <span class="bianji" style="left: -30px;">添加轮播图
                                            <span class="arrowdown"></span>
                                        </span>                            
