 ...
 <div class="row" style="padding: 15px;">
  <div class="col-lg-6">
   <form action="" method="get">
    ...
    <input type="hidden" name="do" value="sjpinglun" />
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" style="padding: 0px 15px;">
                <div class="row">
              	...
              	<tr class="yg5_tr1">
                	<th class="col-md-2 store_td1">商家名称</th>
	                <th class="col-md-3">评价内容</th>
              ...
              <!--   <td>
               ...
               <!--  <td>
                 ...
                 <?php  } ?> -->
                 <td>
                  <a href="<?php  echo $this->createWebUrl('sjpinglun', array('id'=>$item['id'],'op'=>'delete'));?>" class="storespan btn btn-xs" onclick="return confirm('确认删除吗？');return false;">
                      <span class="fa fa-trash-o"></span>
                      <span class="bianji">删除
                          <span class="arrowdown"></span>
                      </span>
                  </a>
                  <!-- <a onclick="if(!confirm('删除后将不可恢复,确定删除吗?')) return false;" href="<?php  echo $this->createWebUrl('sjpinglun', array('id'=>$item['id'],'op'=>'delete'));?>" class="btn btn-default btn-danger" data-toggle="tooltip" data-placement="top" title="" data-original-title="删除"><i class="fa fa-times"></i> </a> -->   
                </td>
              </tr>
