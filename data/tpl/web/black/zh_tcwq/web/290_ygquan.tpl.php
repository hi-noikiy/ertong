        ...
        <div class="panel-body">
			...
			<form class="form-horizontal" action="" method="POST">
				...
				<div class="col-md-12">
					...
					<?php  } ?>
					<?php  if($system['is_yhqqx']==1) { ?>
					<a href="<?php  echo $this->createWebUrl('couponset')?>">
						<div class="col-md-3 quanyg">
							<div class="quan1">
								<div class="quan1_img">
									<img src="../addons/zh_tcwq/template/images/yhq.png">
								</div>
								<div class="quan1_text">
									<p>优惠券</p>
									<p>优惠券</p>
					...
					<?php  } ?>
					<?php  if($system['is_syqx']==1) { ?>

							<a href="<?php  echo $this->createWebUrl('syset')?>">
						<div class="col-md-3 quanyg">
							<div class="quan1">
								<div class="quan1_img">
									<img src="../addons/zh_tcwq/template/images/sy.png">
								</div>
								<div class="quan1_text">
									<p>收银</p>
									<p>收银</p>
					...
					<?php  } ?>
					<?php  if($system['is_hdqx']==1) { ?>
					<a href="<?php  echo $this->createWebUrl('hdset')?>">
						<div class="col-md-3 quanyg">
							<div class="quan1">
								<div class="quan1_img">
									<img src="../addons/zh_tcwq/template/images/hd.png">
								</div>
								<div class="quan1_text">
									<p>活动报名</p>
									<p>活动报名</p>
					...
					<?php  } ?>
					<?php  if($system['is_qgqx']==1) { ?>
					<a href="<?php  echo $this->createWebUrl('qgset')?>">
						<div class="col-md-3 quanyg">
							<div class="quan1">
								<div class="quan1_img">
									<img src="../addons/zh_tcwq/template/images/xsqg.png">
								</div>
								<div class="quan1_text">
									<p>限时抢购</p>
									<p>限时抢购</p>
					...
					<?php  } ?>
					<?php  if($system['g_qx']==1) { ?>
					<a href="<?php  echo $this->createWebUrl('groupgoodscheck')?>">
						<div class="col-md-3 quanyg">
							<div class="quan1">
								<div class="quan1_img">
									<img src="../addons/zh_tcwq/template/images/zhekouquan.png">
								</div>
								<div class="quan1_text">
									<p>拼团</p>
									<p>拼团</p>
				...
				<?php  if($system['is_hbqx']==1) { ?>
					...
					<?php  } ?>
					<?php  if($system['is_jfqx']==1) { ?>
					<a href="<?php  echo $this->createWebUrl('jfsz')?>">
						<div class="col-md-3 quanyg">
							<div class="quan1">
								<div class="quan1_img">
									<img src="../addons/zh_tcwq/template/images/jf.png">
								</div>
								<div class="quan1_text">
									<p>积分功能</p>
									<p>积分功能</p>
					...
					<?php  } ?>
					<?php  if($system['is_spqx']==1) { ?>
							<a href="<?php  echo $this->createWebUrl('spsz')?>">
						<div class="col-md-3 quanyg">
							<div class="quan1">
								<div class="quan1_img">
									<img src="../addons/zh_tcwq/template/images/sp.png">
								</div>
								<div class="quan1_text">
									<p>商品功能</p>
									<p>商品功能</p>
					...
					<?php  } ?>
					<?php  if($system['is_message']==1) { ?>
					<a href="<?php  echo $this->createWebUrl('message')?>">
						<div class="col-md-3 quanyg">
							<div class="quan1">
								<div class="quan1_img">
									<img src="../addons/zh_tcwq/template/images/mbxx.png">
								</div>
								<div class="quan1_text">
									<p>消息推送</p>
									<p>消息推送</p>
