                ...
                <table class="yg5_tabel col-md-12">
                    ...
                    <tr class="yg5_tr2">
                        ...
                        <a href="javascript:void(0);" data-toggle="modal" data-target="#myModalb<?php  echo $row['id'];?>"><span class="btn btn-xs ygyouhui2">充值余额</span> </a>
                         <a href="javascript:void(0);" data-toggle="modal" data-target="#myModalb2<?php  echo $row['id'];?>"><span class="btn btn-xs ygyouhui2">充值积分</span> </a>
                        <?php  if($row['state']==1) { ?>
                          ...
                          <form action="" method="post" enctype="multipart/form-data">
                              <div class="modal-content">
                                  ...
                                  <div class="modal-footer">
                                   ...
                                   <div class="modal fade" id="myModalb2<?php  echo $row['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document" style="min-width: 300px!important;width: 250px;">
                          <form action="" method="post" enctype="multipart/form-data">
                              <div class="modal-content">
                                  <div class="modal-header">
