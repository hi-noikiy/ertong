            ...
            <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <label class="radio-inline">
                            <input type="radio" id="emailwy1" name="is_sp" value="1" <?php  if($item['is_sp']==1 || empty($item['is_sp'])) { ?> checked <?php  } ?> />
                            <label for="emailwy1">开启</label>
                        </label>
                        <label class="radio-inline">
                            <input type="radio" id="emailwy2" name="is_sp" value="2" <?php  if($item['is_sp']==2) { ?> checked <?php  } ?> />
