...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="<?php  echo $this->createWebUrl('zhanghao')?>">账号管理</a></li>
    <li><a href="<?php  echo $this->createWebUrl('addzhanghao')?>">添加/编辑账号</a></li>
</ul>
<div class="main">
                ...
                <table class="yg5_tabel col-md-12">
                    ...
                    <tr class="yg5_tr2">                      
                      ...
                      <?php  } else if($item['status']==1) { ?>
                       ...
                       <?php  } ?>
                        <td>
                            <a href="<?php  echo $this->createWebUrl('addzhanghao', array('id' => $item['id']))?>" class="storespan btn btn-xs">
                    ...
                    <div class="modal fade" id="myModal<?php  echo $item['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        ...
                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <a href="<?php  echo $this->createWebUrl('zhanghao', array('op' => 'delete', 'id' => $item['id']))?>" type="button" class="btn btn-info" >确定</a>
                        </div>
                    </div>
                </div>
            </div>
