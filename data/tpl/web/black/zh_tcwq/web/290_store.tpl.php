...
<div class="main">
 ...
 <td><?php  echo $item['type_name'];?></td>
                        <td class="rel" style="overflow: hidden;">
                            <?php  if($item['is_rm']==1) { ?>
                              <div class="ab" style="background: orange;transform:rotate(-45deg);padding: 2px 20px;left:-20px;top: 4px;color: #fff;">品牌</div>
                                <?php  } ?><img class="store_list_img" src="<?php  echo tomedia($item['logo']);?>" alt=""/></td>
                           ...
                           <button class="btn btn-xs btn-info czbtn">操作
                                ...
                                <li>
                                  <a href="<?php  echo $this->createWebUrl('storeinfo',array('id'=>$item['id']));?>" class="czstorespan btn btn-xs">
                                    ...
                                    <span class="cztext">商家编辑</span>
                                </a>
                                </li>                                                              
                                <li>
                                  <a href="<?php  echo $this->createWebUrl('addsjaccount',array('id'=>$item['id']));?>" class="czstorespan btn btn-xs">
                                    <span class="fa fa-plus" style="margin:0px;"></span>
                                    <span class="cztext">账号编辑</span>
                                </a>
                                </li>
	                           		<li>
