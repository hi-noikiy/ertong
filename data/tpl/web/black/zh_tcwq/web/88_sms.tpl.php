    ...
    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" id="invitative">
        <div class="panel panel-default ygdefault">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">短信模板id(验证码)：</label>
                    <div class="col-sm-9">
                        <input type="text" name="tpl_id" value="<?php  echo $item['tpl_id'];?>" id="web_name" class="form-control" />
                        <div class="help-block">商家入驻收到短信通知</div>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">短信模板id(通知)：</label>
                    <div class="col-sm-9">
                        <input type="text" name="tpl2_id" value="<?php  echo $item['tpl2_id'];?>" id="web_name" class="form-control" />
                        <div class="help-block">用户购买商品商家收到短信通知</div>
                    </div>
                </div>
            </div>
        </div>
