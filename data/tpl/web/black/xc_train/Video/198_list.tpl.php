...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <ul class="nav nav-tabs">
            <li role="presentation"><a href="<?php  echo url('site/entry/Video_class',array('m'=>$_GPC['m'],'version_id'=>$_GPC['version_id']));?>">视频分类</a></li>
            <li role="presentation" class="active"><a>视频列表</a></li>
            <li role="presentation"><a href="<?php  echo url('site/entry/Video',array('m'=>$_GPC['m'],'op'=>'record','version_id'=>$_GPC['version_id']));?>">购买记录</a></li>
        </ul>
            ...
            <div class="table-responsive panel-body">
                <table class="table-striped table-bordered table-hover dataTables-example table">
                    ...
                    <tr>
                        ...
                        <td><div class="type-parent"><?php  echo $item['service_name'];?></div></td>
