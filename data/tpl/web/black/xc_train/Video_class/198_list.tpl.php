...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <ul class="nav nav-tabs">
            <li role="presentation" class="active"><a>视频分类</a></li>
            <li role="presentation"><a href="<?php  echo url('site/entry/Video',array('m'=>$_GPC['m'],'version_id'=>$_GPC['version_id']));?>">视频列表</a></li>
