...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <ul class="nav nav-tabs">
            <li role="presentation"><a href="<?php  echo url('site/entry/Service',array('m'=>$_GPC['m'],'version_id'=>$_GPC['version_id']));?>">分类</a></li>
            <li role="presentation"><a href="<?php  echo url('site/entry/Service',array('m'=>$_GPC['m'],'version_id'=>$_GPC['version_id']));?>">列表</a></li>
            <li role="presentation"><a href="<?php  echo url('site/entry/Teacher',array('m'=>$_GPC['m'],'version_id'=>$_GPC['version_id']));?>">名师</a></li>
            <li role="presentation" class="active"><a>开课</a></li>
                ...
                <div class="row" style="padding: 0 15px;">
                    <div class="col-sm-3">
                        <select class="selectpicker show-tick form-control bs-select-hidden" data-live-search="true" name="pid" style="width: 50%;">
                            ...
                            <option value="<?php  echo $vo['id'];?>" <?php  if($vo['id']==$pid) { ?>selected<?php  } ?>><?php  echo $vo['name'];?></option>
                            <?php  } } ?>
                        </select>
                    </div>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" placeholder="标识" name="mark" value="<?php  echo $mark;?>">
                    </div>
                    <div class="col-sm-3">
                        <select class="selectpicker show-tick form-control bs-select-hidden" data-live-search="true" name="type" style="width: 50%;">
                            ...
                            <option value="1" <?php  if($type==1) { ?>selected<?php  } ?>>公开课</option>
                            <option value="2" <?php  if($type==2) { ?>selected<?php  } ?>>新开课</option>
                        </select>
                    </div>
                    <div class="col-sm-2">
            ...
            <div class="table-responsive panel-body">
                <table class="table-striped table-bordered table-hover dataTables-example table">
                    ...
                    <tr>
                        ...
                        <td><div class="type-parent"><?php  echo $item['mark'];?></div></td>
                        <td><div class="type-parent"><?php  if($item['type']==1) { ?>公开课<?php  } else { ?>新开课<?php  } ?></div></td>
                        <td><div class="type-parent"><?php  echo $item['member'];?></div></td>
