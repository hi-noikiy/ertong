        ...
        <div class="ibox-content">
            <form action="<?php  echo url('site/entry/'.$_GPC['do'],array('m'=>$_GPC['m'],'version_id'=>$_GPC['version_id']));?>" id="searchform" method="get">
                ...
                <div class="row" style="padding: 0 15px;">
                    <div class="col-sm-3">
                        <input type="text" class="form-control" placeholder="名称" name="title" value="<?php  echo $title;?>">
                    </div>
                    <div class="col-sm-2">
            ...
            <div class="table-responsive panel-body">
                <table class="table-striped table-bordered table-hover dataTables-example table">
                    ...
                    <tr>
                        ...
                        <td><div class="type-parent"><img src="<?php  echo tomedia($item['simg']);?>" width="180" height="150"/></div></td>
