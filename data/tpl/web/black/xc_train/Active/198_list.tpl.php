...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <ul class="nav nav-tabs">
            <li role="presentation" class="active"><a>优惠活动</a></li>
            <li role="presentation"><a href="<?php  echo url('site/entry/Prize2',array('m'=>$_GPC['m'],'version_id'=>$_GPC['version_id']));?>">奖品</a></li>
            <li role="presentation"><a href="<?php  echo url('site/entry/Prize',array('m'=>$_GPC['m'],'version_id'=>$_GPC['version_id']));?>">获奖记录</a></li>
        </ul>
            ...
            <div class="table-responsive panel-body">
                <table class="table-striped table-bordered table-hover dataTables-example table">
                    ...
                    <tr>
                        ...
                        <td><div class="type-parent"><img src="<?php  echo tomedia($item['bimg']);?>" width="75" height="75"/></div></td>
                        <td><div class="type-parent"><?php  echo $item['share'];?></div></td>
                        <td><div class="type-parent"><?php  echo $item['total'];?></div></td>
                        <td><div class="type-parent"><?php  echo $item['is_total'];?></div></td>
