...
<div class="panel-body" style="font-size: 12px;">
    <div class="ibox-content">
        <form action="<?php  echo url('site/entry/'.$_GPC['do'],array('m'=>$_GPC['m'],'op'=>'teacher','version_id'=>$_GPC['version_id']));?>" id="searchform" method="post">
        ...
        <div class="table-responsive panel-body">
            <table class="table-striped table-bordered table-hover dataTables-example table">
                ...
                <tr>
                    ...
                    <td><div class="type-parent"><?php  echo $item['students'];?></div></td>
    ...
    $(function(){
        $(".choose").click(function(){
            if(window.parent.objc!=""){
                ...
                $(window.parent.objc).parent().prev().val(name);
                $(window.parent.objc).parent().prev().attr("data-id",id);
