                ...
                <table class="table-striped table-bordered table-hover dataTables-example table">
                    ...
                    <tr>
                        ...
                        <!--<td style="text-align: right;">-->
                            <?php  if($item['shop']==1) { ?>
                            <!--<a class="btn btn-danger btn-xs edit" data-id="<?php  echo $item['id'];?>" data-status="-1"><i class="fa fa-edit"></i>解绑</a>-->
                            <?php  } else { ?>
                            <!--<a class="btn btn-primary btn-xs edit" data-id="<?php  echo $item['id'];?>" data-status="1"><i class="fa fa-edit"></i>绑定</a>-->
                            <?php  } ?>
                        <!--</td>-->
                    </tr>
                    <?php  } } ?>
...
<div class="modal fade" id="sort_link"><div class="modal-dialog">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <iframe width="100%" height="395" frameborder="no" border="0" scrolling="no" allowtransparency="yes" src="<?php  echo url('site/entry/'.$_GPC['do'],array('m'=>$_GPC['m'],'op'=>'service'));?>"></iframe>
        </div>
