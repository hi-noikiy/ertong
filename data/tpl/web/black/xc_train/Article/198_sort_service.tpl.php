...
<div class="panel-body" style="font-size: 12px;">
    <div class="ibox-content">
        <form style="font-size: 12px;" action="<?php  echo url('site/entry/'.$_GPC['do'],array('m'=>$_GPC['m'],'op'=>'sort_service','version_id'=>$_GPC['version_id']));?>" id="searchform" method="post">
            <div class="row" style="padding: 0 15px;display: flex;align-items: center;">
                ...
                <div style="width:22.222%;display: inline-block;">
    ...
    <form action="" method="post" class="form-horizontal form" style="font-size: 12px;margin-top: 10px;">
        ...
        <div class="table-responsive panel-body">
            <table class="table-striped table-hover dataTables-example table" style="font-size: 12px;">
                ...
                <tr>
                    ...
                    <td style="text-align:right;">
                        <a data-dismiss="modal" class="btn btn-info btn-xs choose" data-id="<?php  echo $item['id'];?>" data-name="<?php  echo $item['name'];?>"><i class="fa fa-check-square-o"></i>选择</a>
                </tr>
                <?php  } } ?>
                </tbody>
            </table>
...
<script>
    $(function(){
        $(".choose").click(function(){
            if(window.parent.sort_objc!=""){
                var id=$(this).attr("data-id");
                var name=$(this).attr("data-name");
                $(window.parent.objc).parent().prev().val("/xc_beauty/pages/service/detail?&id="+id);
