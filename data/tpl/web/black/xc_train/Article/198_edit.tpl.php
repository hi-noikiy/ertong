    ...
    <div class="panel-body">
        <form id="sign-form" class="form-horizontal" role="form" method="post" action="<?php  echo url('site/entry/'.$_GPC['do'],array('m'=>$_GPC['m'],'op'=>'savemodel','version_id'=>$_GPC['version_id']));?>" name="submit" style="padding: 20px 0;">
            ...
            <!--<div class="form-group">-->
                ...
                <!--<div class="col-sm-8">-->
                    <!--<select class="selectpicker show-tick form-control bs-select-hidden" data-live-search="true" name="type" style="width: 50%;">-->
                        ...
                        <!--<option value="1" <?php  if($list['type']==1) { ?>selected<?php  } ?>>普通文章</option>-->
                        <!--<option value="2" <?php  if($list['type']==2) { ?>selected<?php  } ?>>优惠活动文章</option>-->
                    <!--</select>-->
                <!--</div>-->
            <!--</div>-->
            <!--<div class="form-group">-->
            ...
            <!--<div class="form-group">-->
                ...
                <!--<div class="col-sm-8">-->
                    <!--<input type="text" class="form-control"  name="btn" id="btn" value="<?php  echo $list['btn'];?>">-->
                <!--</div>-->
            <!--</div>-->
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <label class="radio inline" style="width: 60px;">
                        <input type="radio" class="ui-radio" name="link_type" id="link_type1" value="1" <?php  if($list['link_type']==1) { ?>checked<?php  } ?>>H5模式
                    </label>
                    <label class="radio inline" style="width: 80px;">
                        <input type="radio" class="ui-radio" name="link_type" id="link_type2" value="2" <?php  if($list['link_type']==2) { ?>checked<?php  } ?>>小程序模式
                    </label>
                </div>
            </div>
            <div class="form-group">
        ...
        <div class="modal-body">
            <div class="tab-content ">
                <div class="tab-pane active" id="sort_service">
                    <iframe width="100%" height="395" frameborder="no" border="0" scrolling="no" allowtransparency="yes" src="<?php  echo url('site/entry/'.$_GPC['do'],array('m'=>$_GPC['m'],'op'=>'sort_service'));?>"></iframe>
                </div>
            </div>
        </div>
