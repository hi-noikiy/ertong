...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <ul class="nav nav-tabs">
            ...
            <li role="presentation" class="active"><a>课程海报配置</a></li>
        </ul>
...
<script type="text/javascript">
    ...
    $(".addtitle").click(function(){
        ...
        $("#editdiv").append('<div id="'+nid+'" class="resize-item text" data-color="#000" data-px="16" data-type="title">课程名称</div>');
        new ZResize({
            stage: "#editdiv", //舞台
            item: nidc, //可缩放的类名
        });
    ...
    $(".addprice").click(function(){
        ...
        $("#editdiv").append('<div id="'+nid+'" class="resize-item text" data-color="#000" data-px="16" data-type="price">课程价格</div>');
        new ZResize({
            stage: "#editdiv", //舞台
            item: nidc, //可缩放的类名
        });
