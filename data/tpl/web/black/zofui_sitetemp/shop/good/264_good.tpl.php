	  			...
	  			<label for="" class="frm_label">快递配送</label>
	   			<div class="frm_controls">
	    			<label class="frm_radio_label show_item" showitem=".isexpress">
	    				...
	    				<input type="radio" name="isexpress" value="0" class="frm_radio" <?php  if($info['isexpress'] == 0) { ?>checked="checked"<?php  } ?> />
	    			</label>
	    			<label class="frm_radio_label hide_item" hideitem=".isexpress">
	    				<i class="icon_radio"></i>
	    				<span class="lbl_content">关闭</span>
	    				<input type="radio" name="isexpress" value="1" class="frm_radio" <?php  if($info['isexpress'] == 1) { ?>checked="checked"<?php  } ?> /> 
	    			</label>	    			
	   			</div>
	  		</div>
	  		<div class="isexpress hideitem" <?php  if($info['isexpress'] == 0) { ?>style="display:block"<?php  } ?>>
				<div class="frm_control_group">
					<label for="" class="frm_label">快递运费</label>
					<div class="frm_controls">
						<span class="frm_input_box frm_input_200">
							<input type="text" class="frm_input"  name="expressmoney" value="<?php  echo $info['expressmoney'];?>">
						</span>
		  			...
		  			<label for="" class="frm_label">运费叠加方式</label>
		   			<div class="frm_controls">
		    			<label class="frm_radio_label">
		    				...
		    				<input type="radio" name="isaddex" value="0" class="frm_radio" <?php  if($info['isaddex'] == 0) { ?>checked="checked"<?php  } ?> />
		    			</label>
		    			<label class="frm_radio_label">
		    				<i class="icon_radio"></i>
		    				<span class="lbl_content">不叠加</span>
		    				<input type="radio" name="isaddex" value="1" class="frm_radio" <?php  if($info['isaddex'] == 1) { ?>checked="checked"<?php  } ?> />
		    			</label>
	  			...
	  			<label for="" class="frm_label">上店自提</label>
	   			<div class="frm_controls">
	    			<label class="frm_radio_label  hide_item" hideitem=".selftake">
	    				<i class="icon_radio"></i>
	    				<span class="lbl_content">关闭</span>
	    				<input type="radio" name="isselftake" value="0" class="frm_radio" <?php  if($info['isselftake'] == 0) { ?>checked="checked"<?php  } ?> />
	    			</label>
	    			<label class="frm_radio_label show_item" showitem=".selftake">
	    				<i class="icon_radio"></i>
	    				<span class="lbl_content">开启</span>
	    				<input type="radio" name="isselftake" value="1" class="frm_radio" <?php  if($info['isselftake'] == 1) { ?>checked="checked"<?php  } ?> /> 
	    			</label>
	    			<p class="frm_tips">请在参数设置内设置好门店名称、电话和地址</p>    			
	   			</div>
	  		</div>
			<div class="hideitem selftake" <?php  if($info['isselftake'] == 1) { ?>style="display:block"<?php  } ?>>

				<!-- <div class="frm_control_group" >
					<label for="" class="frm_label">自提店电话</label>
					<div class="frm_controls">
						<span class="frm_input_box frm_input_200">
							<input type="text" class="frm_input"  name="shoptel" value="<?php  echo $info['shoptel'];?>">
						</span>
						<p class="frm_tips">填0不收运费，单位：元/件</p>
					</div>
				</div>
				<div class="frm_control_group">
					...
					<div class="frm_controls msg">
						<span class="frm_textarea_box textarea_60px">
							<textarea  name="shopaddress" class="frm_textarea" rows="6" placeholder=""><?php  echo $info['shopaddress'];?></textarea>
						</span>
					</div>
				</div>-->
			</div>
	  			...
	  			<label for="" class="frm_label">详情页开关购买</label>
	   			<div class="frm_controls">
	    			<label class="frm_radio_label " >
	    				<i class="icon_radio"></i>
	    				<span class="lbl_content">开启</span>
	    				<input type="radio" name="iscanbuy" value="0" class="frm_radio" <?php  if($info['iscanbuy'] == 0) { ?>checked="checked"<?php  } ?> />
	    			</label>
	    			<label class="frm_radio_label" >
	    				<i class="icon_radio"></i>
	    				<span class="lbl_content">关闭</span>
	    				<input type="radio" name="iscanbuy" value="1" class="frm_radio" <?php  if($info['iscanbuy'] == 1) { ?>checked="checked"<?php  } ?> /> 
	    			</label>
	  			...
	  			<label for="" class="frm_label">开关显示价格销量</label>
	   			<div class="frm_controls">
	    			<label class="frm_radio_label " >
	    				...
	    				<input type="radio" name="isprice" value="0" class="frm_radio" <?php  if($info['isprice'] == 0) { ?>checked="checked"<?php  } ?> />
	    			</label>
	    			<label class="frm_radio_label" >
	    				<i class="icon_radio"></i>
	    				<span class="lbl_content">不显示</span>
	    				<input type="radio" name="isprice" value="1" class="frm_radio" <?php  if($info['isprice'] == 1) { ?>checked="checked"<?php  } ?> />
	    			</label>
	  			...
	  			<label for="" class="frm_label">商品标签</label> 
	   			<div class="frm_controls"> 
					<div class="edit_right_list width_550 group_icon_box">
						...
						<?php  } else { ?>
							<?php  if(is_array($info['icon'])) { foreach($info['icon'] as $item) { ?>
								<div class="edit_right_item">
									名称<span class="frm_input_box frm_input_box_150">
										<input type="text" class="frm_input"  name="iconname[]" value="<?php  echo $item['name'];?>">
									</span>属性<span class="frm_input_box frm_input_box_300">
										<input type="text" class="frm_input"  name="icondesc[]" value="<?php  echo $item['desc'];?>">
									</span>
									<a href="javascript:;" class="delete_params">删除</a>
								</div>
							<?php  } } ?>
			...
			<div class="frm_control_group">
				...
				<div class="frm_controls">
					<span class="frm_input_box frm_input_600">
						<input type="text" class="frm_input"  name="vurl" value="<?php  echo $info['vurl'];?>">
					</span>
		   ...
		   <?php  if(is_array($list)) { foreach($list as $item) { ?>
		    	<tr> 
				    ...
				    <td class="table_cell oper last_child tr opclass" style="position: relative;">
				    	...
				    	<a href="javascript:;" class="copy_url" data-href="<?php echo '/zofui_sitetemp/pages/good/good?gid='.$item['id']?>">复制路径</a>
