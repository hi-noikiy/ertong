...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <ul class="nav nav-tabs">
            <li role="presentation"><a href="<?php  echo url('site/entry/Pick_class',array('m'=>$_GPC['m'],'version_id'=>$_GPC['version_id']));?>">分类</a></li>
            <li role="presentation" class="active"><a>货品</a></li>
            <li role="presentation"><a href="<?php  echo url('site/entry/Pick_order',array('m'=>$_GPC['m'],'version_id'=>$_GPC['version_id']));?>">订单</a></li>
        </ul>
            ...
            <div class="table-responsive panel-body">
                <table class="table-striped table-bordered table-hover dataTables-example table">
                    ...
                    <tr>
                        ...
                        <td><div class="type-parent"><?php  echo $item['cid_name'];?></div></td>
                        <td><div class="type-parent"><?php  echo $item['price'];?>元<?php  if($item['unit']) { ?>/<?php  echo $item['unit'];?><?php  } ?></div></td>
