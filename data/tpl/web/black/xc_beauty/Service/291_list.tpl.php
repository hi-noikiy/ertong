...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <ul class="nav nav-tabs">
            ...
            <li role="presentation"><a href="<?php  echo url('site/entry/Times',array('m'=>$_GPC['m'],'version_id'=>$_GPC['version_id']));?>">预约时间</a></li>
            <li role="presentation"><a href="<?php  echo url('site/entry/Prize',array('m'=>$_GPC['m'],'version_id'=>$_GPC['version_id']));?>">奖品</a></li>
                ...
                <table class="table-striped table-bordered table-hover dataTables-example table">
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;">
                            <a href="javascript:;" class="btn btn-info btn-xs" onclick="copy(this)" data-theme="<?php  echo $theme;?>" data-id="<?php  echo $item['id'];?>">复制地址</a>
...
<script>
    require(["../addons/<?php  echo $_GPC['m']?>/resource/swal/dist/sweetalert2.min.js","../addons/<?php  echo $_GPC['m']?>/resource/bootstrap-select/bootstrap-select.min.js","../web/resource/js/lib/clipboard.min.js"],function(){
        $(function(){
            //改变状态
    ...
    function copy(objc){
        ...
        var theme=$(objc).attr("data-theme");
        var shareurl="";
        if(theme==3){
            shareurl = '/xc_beauty/ui2/service/detail?id=' +id;
        }else{
            shareurl = '/xc_beauty/service/detail?id=' +id;
        }
        $("#copy").val(shareurl);
        $("#copy").select(); //选择对象
