...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <ul class="nav nav-tabs">
            <li role="presentation" class="active"><a>新人礼包</a></li>
            <li role="presentation"><a href="<?php  echo url('site/entry/Area_item',array('m'=>$_GPC['m'],'version_id'=>$_GPC['version_id']));?>">礼包内容</a></li>
        </ul>
