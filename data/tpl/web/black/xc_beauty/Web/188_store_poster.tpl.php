...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <ul class="nav nav-tabs">
            ...
            <li role="presentation" class="active"><a>门店海报配置</a></li>
                ...
                <div class="col-md-10 col-sm-9 col-xs-12">
                    <div class="contain flex-display">
                        ...
                        <div class="pane2 flex-flex1">
                            <h1>海报元素</h1>
                            <div class="btns">
                                <a href="javascript:;" class="adduimg">封面</a>
                                <a href="javascript:;" class="addtitle">门店名称</a>
                                <a href="javascript:;" class="addmobile">电话</a>
...
<script type="text/javascript">
    ...
    $(".adduimg").click(function(){
        ...
        $("#editdiv").append('<div id="'+nid+'" class="resize-item uimg" data-type="bimg" style="width: 100%;height: 150px;">\
            <img src="../addons/xc_beauty/resource/images/partners-1.jpg">\
        </div>');
        new ZResize({
            stage: "#editdiv", //舞台
            item: nidc, //可缩放的类名
    ...
    $(".addtitle").click(function(){
        ...
        $("#editdiv").append('<div id="'+nid+'" class="resize-item text" data-color="#000" data-px="16" data-bold="-1" data-center="-1" data-type="name">门店名称</div>');
        new ZResize({
            stage: "#editdiv", //舞台
            item: nidc, //可缩放的类名
        });
    ...
    $(".addmobile").click(function(){
        ...
        $("#editdiv").append('<div id="'+nid+'" class="resize-item text" data-color="#000" data-px="16" data-bold="-1" data-center="-1" data-type="mobile">电话</div>');
        new ZResize({
            stage: "#editdiv", //舞台
            item: nidc, //可缩放的类名
        });
