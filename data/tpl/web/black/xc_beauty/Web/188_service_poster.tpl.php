...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <ul class="nav nav-tabs">
            ...
            <li role="presentation" class="active"><a>分销海报配置</a></li>
                    ...
                    <div class="contain flex-display">
                        ...
                        <div class="pane2 flex-flex1">
                            ...
                            <div class="btns">
                                ...
                                <a href="javascript:;" class="addtitle">昵称</a>
...
<script type="text/javascript">
    ...
    $(".addtext").click(function(){
        ...
        $("#editdiv").append('<div id="'+nid+'" class="resize-item text" data-color="#000" data-px="16" data-bold="-1" data-type="text">自定义内容</div>');
        new ZResize({
            stage: "#editdiv", //舞台
            item: nidc, //可缩放的类名
        });
    ...
    $(".addtitle").click(function(){
        ...
        $("#editdiv").append('<div id="'+nid+'" class="resize-item text" data-color="#000" data-px="16" data-bold="-1" data-type="nick">昵称</div>');
        new ZResize({
            stage: "#editdiv", //舞台
            item: nidc, //可缩放的类名
        });
