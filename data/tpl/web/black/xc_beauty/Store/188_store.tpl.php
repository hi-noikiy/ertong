...
<div class="panel-body" style="font-size: 12px;">
    <div class="ibox-content">
        <form action="<?php  echo url('site/entry/'.$_GPC['do'],array('m'=>$_GPC['m'],'op'=>'store','version_id'=>$_GPC['version_id']));?>" id="searchform" method="post">
            <div class="row" style="padding: 0 15px;">
                ...
                <div style="width: 25%;display: inline-block;margin-right: 5px;">
                    ...
                    <button class="btn btn-primary choose" style="margin-right:5px;" data-id="-1">默认店铺</button>
                </div>
            </div>
        </form>
    </div>
    ...
    $(function(){
        $(".choose").click(function(){
            if(window.parent.obj!=""){
                ...
                $(window.parent.obj).parent().prev().val('store$'+id);
