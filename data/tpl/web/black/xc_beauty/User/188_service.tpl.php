    ...
    require(["../addons/<?php  echo $_GPC['m']?>/resource/swal/dist/sweetalert2.min.js"],function(){
        $(function(){
            $(".choose").click(function(){
                var type=$(window.parent.objc).attr("data-type");
                ...
                if(type=='shop'){
                    ...
                    $("#store1",window.parent.document).attr("data-store",store);
                    $("#store1",window.parent.document).attr("data-name",name);
                    $("#sort_close",window.parent.document).click();
                    $("#store1",window.parent.document).click();
                }
            });
        })
    })
