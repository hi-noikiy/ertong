        ...
        <div class="ibox-content">
            <form action="<?php  echo url('site/entry/'.$_GPC['do'],array('m'=>$_GPC['m'],'version_id'=>$_GPC['version_id']));?>" id="searchform" method="post">
                <div class="row" style="padding: 0 15px;">
                    <div class="col-sm-3">
                        <input type="text" class="form-control" placeholder="优惠价格" name="xname" value="<?php  echo $xname;?>">
                    </div>
                    <div class="col-sm-2">
                        <button type="submit" class="btn btn-default " style="margin-right:5px;">查询</button>
                        <a class="btn btn-primary" href="<?php  echo url('site/entry/'.$_GPC['do'],array('m'=>$_GPC['m'],'op'=>'edit'));?>">增加</a>
                    </div>
                </div>
            </form>
        </div>
            ...
            <div class="table-responsive panel-body">
                <table class="table-striped table-bordered table-hover dataTables-example table">
                    ...
                    <tr>
                        ...
                        <td><div class="type-parent"><?php  echo $item['type_name'];?></div></td>
                        <td><div class="type-parent"><?php  echo $item['condition'];?></div></td>
                        <td><div class="type-parent"><?php  echo $item['times']['start'];?>至<?php  echo $item['times']['end'];?></div></td>
                        <td><div class="type-parent"><?php  if($item['total']==-1) { ?>不限<?php  } else { ?><?php  echo $item['total'];?><?php  } ?></div></td>
