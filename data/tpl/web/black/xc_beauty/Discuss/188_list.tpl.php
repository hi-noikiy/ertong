...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <ul class="nav nav-tabs">
            ...
            <li role="presentation"><a href="<?php  echo url('site/entry/'.$_GPC['do'],array('m'=>$_GPC['m'],'op'=>'list2','version_id'=>$_GPC['version_id']));?>">技师评论</a></li>
            <li role="presentation"><a href="<?php  echo url('site/entry/'.$_GPC['do'],array('m'=>$_GPC['m'],'op'=>'list3','version_id'=>$_GPC['version_id']));?>">客服记录</a></li>
        </ul>
                ...
                <table class="table-striped table-bordered table-hover dataTables-example table">
                    ...
                    <tr>
                        ...
                        <td><div class="type-parent">
                            <?php  if(is_array($item['imgs'])) { foreach($item['imgs'] as $index => $item2) { ?>
                            <img src="<?php  echo $item2;?>" width="50" height="50"/>
                            <?php  } } ?>
                        </div></td>
