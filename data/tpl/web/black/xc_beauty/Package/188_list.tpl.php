...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <ul class="nav nav-tabs">
            ...
            <li role="presentation"><a href="<?php  echo url('site/entry/Store_service',array('m'=>$_GPC['m'],'version_id'=>$_GPC['version_id']));?>">门店项目</a></li>
            ...
            <li role="presentation" class="active"><a>套餐</a></li>
        </ul>
                ...
                <table class="table-striped table-bordered table-hover dataTables-example table">
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;">
                            <a href="<?php  echo url('site/entry/'.$_GPC['do'],array('m'=>$_GPC['m'],'op'=>'edit','id'=>$item['id'],'version_id'=>$_GPC['version_id']));?>" class="btn btn-primary btn-xs edit"><i class="fa fa-edit"></i>修改</a>
