                ...
                <?php  if($item['order']['state']==1 || $item['order']['state']==6) { ?>
                    ...
                    <div class="col-md-12 orderback">
                        ...
                        <div class="left">
                            ...
                            &nbsp;|&nbsp;<?php  if($item['order']['order_type']==2) { ?>自提时间<?php  } else { ?>配送时间<?php  } ?>:<?php  echo $item['order']['delivery_time'];?>
                             &nbsp;|&nbsp;<?php  echo $item['order']['ps_mode'];?>&nbsp;
                            <a href="<?php  echo $this->createWebUrl('order',array('op'=>'dy','order_id'=>$item['order']['id']));?>"><span class="btn btn-xs orderbtn">打印小票</span></a>
                        </div>
                        <div class="right">
                        ...
                        <?php  } else if($item['order']['state']==3) { ?>
                            ...
                            <a href="<?php  echo $this->createWebUrl('order',array('op'=>'wc','id'=>$item['order']['id']));?>"><div class="left orderconfirm">点击完成</div></a>
                             <a href="<?php  echo $this->createWebUrl('order',array('op'=>'cancel','id'=>$item['order']['id']));?>"><div class="left orderconfirm">取消订单</div></a>
                    ...
                    <div class="col-md-12 orderback2">
                        ...
                        <?php  if($item['order']['mj_money']>0) { ?>
                        <div class="orderaccount">
                            <div class="orderbox1 left">满减优惠</div>
                            <div class="orderbox2 left">¥<?php  echo number_format($item['order']['mj_money'],2)?></div>
                        </div>
                        <?php  } ?>
                        <?php  if($item['order']['xyh_money']>0) { ?>
                        <div class="orderaccount">
                            <div class="orderbox1 left">新用户立减</div>
                            <div class="orderbox2 left">¥<?php  echo number_format($item['order']['xyh_money'],2)?></div>
                        </div>
                        <?php  } ?>
                        <?php  if($item['order']['yhq_money']>0) { ?>
                        <div class="orderaccount">
                            <div class="orderbox1 left">优惠券金额</div>
                            <div class="orderbox2 left">¥<?php  echo number_format($item['order']['yhq_money'],2)?></div>
                        </div>
                        <?php  } ?>
                        <?php  if($item['order']['yhq_money2']>0) { ?>
                        <div class="orderaccount">
                            <div class="orderbox1 left">平台优惠</div>
                            <div class="orderbox2 left">¥<?php  echo number_format($item['order']['yhq_money2'],2)?></div>
                        </div>
                        <?php  } ?>
                        <?php  if($item['order']['discount']>0) { ?>
                        <div class="orderaccount">
                            <div class="orderbox1 left">总优惠金额</div>
                    ...
                    <div class="col-md-12 orderback2">
                        <div class="orderaccount orfont7">
                            ...
                            <div class="orderbox2 left">¥<?php  echo number_format($item['order']['money']+$item['order']['yhq_money2']-($item['order']['md_poundage']/100*($item['order']['money']+$item['order']['yhq_money2']-$item['order']['ps_money']))-$item['order']['ps_money']*$item['order']['ps_poundage']/100,2)?></div>
                        
                        </div>
                        <div class="orderaccount orfont6">
                            本单顾客实际支付：¥<?php  echo $item['order']['money'];?> <?php  if($item['order']['yhq_money2']>0) { ?>(平台优惠:<?php  echo $item['order']['yhq_money2'];?>)<?php  } ?>
                        </div>                     
                    </div>
		...
		function addHtml(res){
			if(dis_info!='达达配送'&&dis_info!='快服务配送'){
				if(res.rst.state=='1'){
			    	...
			    	html += '<p style="padding:5px 0;">'+'骑手名字:'+res.transporterName+'</p>'
			    	html += '<p style="padding:5px 0;">'+'联系方式:'+res.transporterPhone+'</p>'
