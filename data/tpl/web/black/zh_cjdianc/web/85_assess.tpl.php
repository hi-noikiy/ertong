...
<ul class="nav nav-tabs">
    ...
    <li <?php  if($_GPC['type']==1) { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('assess',array('type'=>1));?>">全部(<?php  echo count($qb)?>)</a></li>
    <li <?php  if($_GPC['type']==2) { ?> class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('assess',array('type'=>2));?>">未回复(<?php  echo count($whf)?>)</a></li>
                ...
                <?php  if(is_array($list)) { foreach($list as $row) { ?>
                    <tr class="">
                        ...
                        <?php  } } ?>
                            ...
                            <?php  if($row['state']==2) { ?>
                            <div class="record">
                                <p>商家回复:  <?php  echo $row['hf'];?></p>
                                <p>回复时间:  <?php  echo $row['hf_time'];?></p>
                            </div>
                            <?php  } ?>
                        </td>
                        <td class="bottom border">
                            ...
                            <div class="shop_ca">
                                <a href="javascript:;" data-toggle="modal" data-target="#myModalb<?php  echo $row['id'];?>">删除</a>
                      ...
                      <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <a href="<?php  echo $this->createWebUrl('assess', array('op' => 'delete', 'id' => $row['id']))?>" type="button" class="btn btn-info" >确定</a>
                        </div>
                    </div>
                </div>
            </div>
