                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select name="type" class="col-md-4">
                            <option value="1" <?php  if($info['type']==1) { ?>selected<?php  } ?>>多店顶部广告位</option>
                            <option value="2" <?php  if($info['type']==2) { ?>selected<?php  } ?>>开屏广告</option>
                            <option value="3" <?php  if($info['type']==3) { ?>selected<?php  } ?>>多店中部广告位</option>
              ...
              <!--               <option value="9" <?php  if($info['type']==10) { ?>selected<?php  } ?>>抢购广告位</option> -->
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="ygmargin">*首页轮播图建议宽高750*360px　 开屏广告建议宽高650*1156px</div>
                    </div>
                </div>
                <div class="form-group">
