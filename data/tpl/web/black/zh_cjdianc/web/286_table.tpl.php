...
<!--                     <a href="javascript:;" class="storespan btn btn-xs">
                ...
                <div class="yg5_tabel col-md-12">
                       ...
                       <input class="tabel_left" name="test_check" type="checkbox" value="<?php  echo $row['id'];?>" id="demo1"/>
                        <?php  if($row['status']==0) { ?>
    ...
    $(function(){
        ...
        var check = []
        	...
        	if(check.length==0){
        	 ...
        	 $.ajax({
                    type:"post",
                    url:"<?php  echo $_W['siteroot'];?>/app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&do=AllDelTable&m=zh_cjdianc",
                    dataType:"text",
                    data:{id:check},
