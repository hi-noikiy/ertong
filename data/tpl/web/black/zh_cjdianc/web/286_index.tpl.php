...
<div class="col-md-12 date_box">
  <div class="col-md-3 today">
    <h1 style="font-size: 25px;">今日营业额              
		<text style="font-size: 25px;margin-left: 60px;"><?php  echo $jryye;?></text>	
    </h1>
 ...
 <!--    <b><?php  echo $jryye;?></b>
     <p class="side">	
		<text>
			余额支付:<?php  echo $jr_yemoney;?>
		</text>
    <text>
      在线支付:<?php  echo $jrzxyye;?>
    </text>
     </p> -->
  </div>
  <div class="col-md-3 yesterday">
    <h1 style="font-size: 25px;">今日订单      
		<text style="font-size: 25px;margin-left: 60px;"><?php  echo $jrordernum;?></text>	
    </h1>
  ...
  <div class="col-md-3 all_total">
   <h1 style="font-size: 25px;">总营业额      
		<text style="font-size: 25px;margin-left: 60px;"><?php  echo $cost;?></text>	
    </h1>
    <!-- <b><?php  echo $cost;?></b> -->
    <p>到店支付:<?php  echo $xxcost;?></p>
    <p>
    <a class="">余额支付:<?php  echo $yecost;?></a>	
    </p>
    <p>
		 <a href="<?php  echo $this->createWebUrl('zjlist');?>">在线支付:<?php  echo $zxcost;?></a>
		<a style="float: right;" href="<?php  echo $this->createWebUrl('finance');?>">提现</a>
    </p>
    <p>
		
    </p>
    <!-- <a href="<?php  echo $this->createWebUrl('zjlist');?>" class="pay">在线支付:<?php  echo $zxcost;?></a>&nbsp;&nbsp;&nbsp;
     <a class="pay" style="margin-left: 20px;">余额支付:<?php  echo $yecost;?></a>
