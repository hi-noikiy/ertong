...
<ul class="we7-page-tab">
	...
	<li class="<?php  if($do == 'authorizer') { ?>active<?php  } ?>">
		<a href="<?php  echo url('wxapp/front-download/authorizer', array('version_id' => $version_id))?>">功能使用授权</a>
	</li>
...
<?php  if($do == 'authorizer') { ?>
<div class="panel we7-panel">
	<div class="panel-heading">小程序自助授权</div>
	<div class="panel-body we7-padding">
		<?php  echo $auth;?>
	</div>
</div>
